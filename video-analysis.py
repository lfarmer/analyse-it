...
def parse_args():
    ...
    parser.add_argument('--det-config', default='configs/mmdet/rtmdet_m_640-8xb32_coco-person.py', help='Config file for detection')
    parser.add_argument('--det-checkpoint', default='configs/mmdet/rtmdet_m_8xb32-100e_coco-obj365-person-235e8209.pth', help='Checkpoint file for detection')
    parser.add_argument(
        '--pose-estimator-config',
        type=str,
        default='configs/2d/rtmpose-m_8xb256-420e_body8-256x192.py',
        help='Config file for the 1st stage 2D pose estimator')
    parser.add_argument(
        '--pose-estimator-checkpoint',
        type=str,
        default='configs/2d/rtmpose-m_simcc-body7_pt-body7_420e-256x192-e48f03d0_20230504.pth',
        help='Checkpoint file for the 1st stage 2D pose estimator')
    parser.add_argument(
        '--pose-lifter-config',
        default='configs/3d/video-pose-lift_tcn-243frm-supv-cpn-ft_8xb128-200e_h36m.py',
        help='Config file for the 2nd stage pose lifter model')
    parser.add_argument(
        '--pose-lifter-checkpoint',
        default='configs/3d/videopose_h36m_243frames_fullconv_supervised_cpn_ft-88f5abbb_20210527.pth',
...
def main():
    ...
    if input_type == 'image':
        ...
        if args.input == 'webcam':
            ...
            print("file exists?", os.path.exists(args.input))
